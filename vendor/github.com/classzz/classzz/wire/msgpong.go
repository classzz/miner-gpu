...
func (msg *MsgPong) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return readElement(r, &msg.Nonce)
}

// CzzEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgPong) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
