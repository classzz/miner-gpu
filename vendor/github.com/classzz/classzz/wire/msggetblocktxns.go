...
func (msg *MsgGetBlockTxns) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetBlockTxns) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
