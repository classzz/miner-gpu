...
// message. we save bandwidth on the wire by sending a compact block rather than a full block.
...
func (msg *MsgCmpctBlock) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgCmpctBlock) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	for _, ptx := range msg.PrefilledTxs {
		...
		if err := ptx.Tx.CzzEncode(w, pver, enc); err != nil {
			return err
		}
	}
	return nil
