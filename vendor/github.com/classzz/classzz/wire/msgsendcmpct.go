...
func (msg *MsgSendCmpct) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgSendCmpct) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
