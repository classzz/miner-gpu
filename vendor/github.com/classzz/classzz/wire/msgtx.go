...
func (msg *MsgTx) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > uint64(maxTxInPerMessage()) {
		...
		return messageError("MsgTx.CzzDecode", str)
	}
...
// the Version field in the transaction.  This function differs from CzzDecode
// in that CzzDecode decodes from the bitcoin wire protocol as it was sent
...
func (msg *MsgTx) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs from CzzEncode in that CzzEncode
