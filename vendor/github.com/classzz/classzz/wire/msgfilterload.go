...
func (msg *MsgFilterLoad) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if msg.HashFuncs > MaxFilterLoadHashFuncs {
		...
		return messageError("MsgFilterLoad.CzzDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgFilterLoad) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	if size > MaxFilterLoadFilterSize {
		...
		return messageError("MsgFilterLoad.CzzEncode", str)
	}
