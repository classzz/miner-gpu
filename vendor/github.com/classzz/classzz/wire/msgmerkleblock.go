...
func (msg *MsgMerkleBlock) CzzDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > uint64(maxTxPerBlock()) {
		...
		return messageError("MsgMerkleBlock.CzzDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgMerkleBlock) CzzEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
