...
func (msg *MsgGetCFCheckpt) CzzDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFCheckpt) CzzEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
