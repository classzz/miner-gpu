...
func (msg *MsgGetCFilters) CzzDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFilters) CzzEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
