...
func (r FutureGetRawTransactionResult) Receive() (*czzutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[czzutil.Address]czzutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCZZ()
	}
...
func (c *Client) SearchRawTransactionsAsync(address czzutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address czzutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address czzutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address czzutil.Address, skip,
