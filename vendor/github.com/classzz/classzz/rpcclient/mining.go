...
func (c *Client) SubmitBlockAsync(block *czzutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitWorkAsync(Hash string, Nonce uint64) FutureSubmitBlockResult {

	cmd := btcjson.NewSubmitWorkCmd(Hash, Nonce)
	return c.sendCmd(cmd)
}
