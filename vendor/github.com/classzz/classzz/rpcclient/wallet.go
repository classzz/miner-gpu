...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []czzutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []czzutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee czzutil.Amount) FutureSetTxFeeResult {
	cmd := btcjson.NewSetTxFeeCmd(fee.ToCZZ())
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee czzutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address czzutil.Address, amount czzutil.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToCZZ(), nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address czzutil.Address, amount czzutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address czzutil.Address,
	amount czzutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToCZZ(), &comment,
		&commentTo, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address czzutil.Address, amount czzutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentSubFeeAsync(address czzutil.Address, amount czzutil.Amount, comment, commentTo string, subtractFeeFromAmount bool) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToCZZ(), &comment, &commentTo, &subtractFeeFromAmount)
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressCommentSubFee(address czzutil.Address, amount czzutil.Amount, comment, commentTo string, subtractFeeFromAmount bool) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress czzutil.Address, amount czzutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToCZZ(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress czzutil.Address, amount czzutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress czzutil.Address, amount czzutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToCZZ(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress czzutil.Address, amount czzutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress czzutil.Address, amount czzutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress czzutil.Address,
	amount czzutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[czzutil.Address]czzutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToCZZ()
	}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[czzutil.Address]czzutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[czzutil.Address]czzutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[czzutil.Address]czzutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (czzutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return czzutil.DecodeAddress(addmultisigRes.Address, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []czzutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []czzutil.Address, account string) (czzutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []czzutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []czzutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (czzutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return czzutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) GetNewAddress(account string) (czzutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (czzutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (czzutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (czzutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (czzutil.Address, error) {
...
func (c *Client) GetAccountAsync(address czzutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address czzutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address czzutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address czzutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]czzutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]czzutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := czzutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]czzutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount czzutil.Amount) FutureMoveResult {
	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToCZZ(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount czzutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount czzutil.Amount, minConfirms int) FutureMoveResult {

	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToCZZ(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount czzutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount czzutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount czzutil.Amount,
...
func (c *Client) ValidateAddressAsync(address czzutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address czzutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]czzutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]czzutil.Amount)
	for k, v := range accounts {
		amount, err := czzutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]czzutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]czzutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (czzutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := czzutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (czzutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (czzutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (czzutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (czzutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (czzutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (czzutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (czzutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (czzutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (czzutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address czzutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address czzutil.Address) (czzutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address czzutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address czzutil.Address, minConfirms int) (czzutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address czzutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address czzutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address czzutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address czzutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*czzutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return czzutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address czzutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address czzutil.Address) (*czzutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *czzutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *czzutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *czzutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *czzutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *czzutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *czzutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a classzz chain server
...
// backupwallet (NYI in czzwallet)
// encryptwallet (Won't be supported by czzwallet since it's always encrypted)
// getwalletinfo (NYI in czzwallet or btcjson)
// listaddressgroupings (NYI in czzwallet)
// listreceivedbyaccount (NYI in czzwallet)

// DUMP
// importwallet (NYI in czzwallet)
// dumpwallet (NYI in czzwallet)
